...
String getImageUrl(Exercise exercise){
  ...
  if(exercise.hostIconUrl!.isNotEmpty)
    return exercise.hostIconUrl!;
  return "";
}
                  ...
                  children: [
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    color: widget.color,
                                    image: widget.modelDumySend.image!=null&&widget.modelDumySend.image!.length>5? DecorationImage(
                                        image: NetworkImage(
                            ...
                            builder: (context, snapshot) {
                              ...
                              if (snapshot.hasData) {
                                ...
                                if (modelExerciseDetailList.data!.success ==
                                  ...
                                  exerciseTools = modelExerciseDetailList.data!.exercise_tools!;
                                  _list.forEach((price) {
                                    getTime = getTime +
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            SizedBox(width: 5,),
                                            ConstantWidget.getTextWidget(
                                                "${Constants.calFormatter.format(getCal)} "+S.of(context).kcal,
                                                textColor,
                                                TextAlign.start,
                                                FontWeight.w300,
                                                ConstantWidget.getScreenPercentSize(context, 1.7)),
                                          ...
                                          child: (snapshot.hasData)
                                              ? ListView.separated(
                                                  ...
                                                  itemBuilder:
                                                    ...
                                                    return Column(
                                                      children: [
                                                        index==0 || (index>0 && _list[index-1].isStretch.toString() != _list[index].isStretch.toString())?
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              ConstantWidget.getTextWidget(
                                                                  _modelExerciseList.isStretch==true? 'Warm Up': 'Exercises',
                                                                  Colors.black,
                                                                  TextAlign.start,
                                                                  FontWeight.bold,
                                                                  ConstantWidget.getScreenPercentSize(
                    ...
                    Container(
                      ...
                      child: ConstantWidget.getIconButtonWidget(
                          context, 'Start Workout', borderColor: redColor, fillColor : redColor, fontColor : Colors.white, asset: "" ,() async {
