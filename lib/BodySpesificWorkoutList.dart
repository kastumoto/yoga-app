...
class _BodySpecificWorkoutList extends State<BodySpecificWorkoutList>
                            ...
                            builder: (context, snapshot) {
                              ...
                              if (snapshot.hasData) {
                                ModelBodySpecificSubCategoryWorkouts
                                    modelBodySpecificSubCategoryWorkouts = snapshot.data!;
                                if (modelBodySpecificSubCategoryWorkouts.data!.success ==
                                    1) {
                                  _list =
                                  modelBodySpecificSubCategoryWorkouts.data!.workouts!;
                                  _list.forEach((price) {
                                    getTime = getTime +
                                                                              ...
                                                                              Row(
                                                                                children: [
                                                                                  ConstantWidget.getTextWidget(
                                                                                      "${modelOtherWorkoutCategoryWorkout.totalMinutes} sec",
                                                                                      subTextColor,
                                                                                      TextAlign.start,
                                                                                      FontWeight.w500,
                                                                                  ...
                                                                                  SizedBox(width: 10,),
                                                                                  ConstantWidget.getTextWidget(
                                                                                      "${modelOtherWorkoutCategoryWorkout.kcal!} Kcal",
                                                                                      redColor,
                                                                                      TextAlign.start,
                                                                                      FontWeight.w500,
                                                                                      ConstantWidget.getScreenPercentSize(context, 1.6)),
  ...
  void sendToNext(ModelOtherWorkoutCategoryWorkout modelOtherWorkoutCategoryWorkout, int index) {
