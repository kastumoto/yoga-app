...
class ConstantUrl {
  ...
  static String urlGetAllWorkoutsofOneBodySpecific = baseUrl + "bodyworkout.php";
  static String urlGetAllOtherWorkOutCategories = baseUrl + "quickworkoutcategory.php";
  static String urlGetChallengeExercise = baseUrl + "challengesexercise.php";
  static String urlGetALLWorkoutExerciseOfCategory = baseUrl + "categoryexercise.php";
  ...
  static List<IntensivelyModel> getIntensivelyModel() {
    ...
    model.desc =
        "I do some physical activity and moderate\nexercise";
    list.add(model);

    model = new IntensivelyModel();
    model.title = "Advanced";
    model.desc =
        "I do exercise most days and my fitness\nlevel is good";
    list.add(model);
