...
class _SubscriptionWidgetState extends State<SubscriptionWidget> {
  ...
  Widget commentTextWidget(){
    return Container(
      ...
      child: ConstantWidget.getCustomText(
          "No-commitment 7-day trial, cancel at any time.",
          Colors.black,
          1,
          TextAlign.center,
          FontWeight.w600,
  ...
  Widget continueButton(){
    return ConstantWidget.getIconButtonWidget(
        context, 'Continue', borderColor: redColor, fillColor : redColor, fontColor : Colors.white, asset: "" ,() {
  ...
  purchaseNewItem(){
    ...
    if (Platform.isAndroid) {
      ...
      _getOldSubscription(selectedProductDetail!, selectedPurchases!, currentSelectedSubscribeItem);
  ...
  subscriptionItemClicked(Packageplan packageplan, PurchaseDetails? previousPurchase, ProductDetails? productDetails, Map<String, PurchaseDetails> purchases){
    print("item clicked");
                      ...
                      children: [
                        ...
                        Align(
                            ...
                            child: GestureDetector(
                                ...
                                child: Icon(Icons.arrow_back,).marginOnly(left: 10) )),
                        Align(
  ...
  Future<void> deliverProduct(PurchaseDetails purchaseDetails) async {
    ...
    //   });
    // } else {
    await addPurchasePlan(currentSelectedSubscribeItem, changeTimestampToDate(purchaseDetails.transactionDate), purchaseId: purchaseDetails.purchaseID??"noId");
