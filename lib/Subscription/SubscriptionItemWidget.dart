...
class SubscriptionItemWidget extends StatefulWidget {
  ...
  Function callBack;
  SubscriptionItemWidget(this.productDetails, this.previousPurchase, this.packageplan, this.currentSelectedSubscribeId, this.isBestBuy,this.purchases ,this.callBack);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          GestureDetector(
            onTap: (){
              widget.callBack(widget.packageplan, widget.previousPurchase, widget.productDetails, widget.purchases);
            },
            child: Container(
              width: MediaQuery.of(context).size.width/3-40,
              height: 150,
              decoration: BoxDecoration(
                color: widget.currentSelectedSubscribeId == widget.packageplan.planId? Colors.white: greyWhite,
                border: Border.all(
                  width: 2,
                  color: widget.currentSelectedSubscribeId == widget.packageplan.planId? Colors.red: greyWhite,
                ),
