...
class _SignUpDashboardPage extends State<SignUpDashboardPage> {
  ...
  Future<void> fb_login() async {
    final LoginResult result = await FacebookAuth.instance.login(permissions: ['public_profile']); // by default we request the email and the public profile
  ...
  void googlelogin() async{
    try {
      ...
      print(userObj.id);
      GuideIntroModel introModel = new GuideIntroModel();
      introModel.username = userObj.displayName;
      introModel.email = userObj.email;
      introModel.socialId = userObj.id;
  ...
  Future<void> _onPressedAppleSignInButton() async {
    ...
    GuideIntroModel introModel = new GuideIntroModel();
    introModel.username = credential.familyName;
    introModel.email = credential.email;
    introModel.socialId = credential.identityToken;
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Image.asset("assets/images/signupdash_title.png"),),
                          Container(
                            margin: EdgeInsets.fromLTRB(50, 20, 50, 0),
                            child: Image.asset("assets/images/signupdash_subtitle.png"),),
                          SizedBox(
                            height:
                                ConstantWidget.getScreenPercentSize(context, 10),
                          ),
                          ConstantWidget.getIconButtonWidget(
                              context, 'Sign up with Email', borderColor: redColor, fillColor : redColor, fontColor : Colors.white, asset: "assets/images/email_logo.png" ,() {
                              Navigator.pop(context);

                              Get.to(() => SignUpPage());
                          }),
                          ConstantWidget.getIconButtonWidget(
                              context, 'Sign up with Facebook', borderColor: quickSvgColor, fillColor : quickSvgColor, fontColor : Colors.white, asset: "assets/images/facebook_logo.png" ,() {
                            fb_login();
                          }),
                          ConstantWidget.getIconButtonWidget(
                              context, 'Sign up with Google', borderColor: blueButton, fillColor : blueButton, fontColor : Colors.white, asset: "assets/images/google_logo.png" ,() {
                                googlelogin();
                          }),
                          Platform.isIOS?
                            ConstantWidget.getIconButtonWidget(
                                context, 'Sign up with Apple', borderColor: accentColor, fillColor : accentColor, fontColor : Colors.white, asset: "assets/images/apple_logo.png" ,() {
