...
class _HomeWidget extends State<HomeWidget>  {
  ...
  String getUserDetail() {
    if(userDetail!=null && userDetail!.firstName!= null)
      return  userDetail!.firstName!+": 30 Day Body\nTransformation";
    else return "Easy Fit: 30 Day Body\nTransformation";
  }

  @override
  void didChangeDependencies(){
    allDestinations = <Destination>[
      Destination(S.of(context).home, "30 Day Body\nTransformation",//S.of(context).yogaWorkout,
        ...
        child: Obx(() => Scaffold(
              appBar: new AppBar(
                ...
                systemOverlayStyle: SystemUiOverlayStyle(
                    ...
                    statusBarColor: bgDarkWhite),
                title: getCustomText(
                    controller.index.value==0?  getUserDetail(): allDestinations[controller.index.value].toolbarTitle ,
                    accentColor,
