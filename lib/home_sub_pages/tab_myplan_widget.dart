        ...
        for (var i = 0; i < 4; i++) {
          ...
          var cardItem = Positioned.directional(
            ...
            child: ClipRRect(
              ...
              child: Container(
                decoration: _discoverList[i].image!=null && _discoverList[i].image!.length>5? BoxDecoration(
                              ...
                              child: Container(
                                child: Column(
                                  children: [
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: oneDay.image!=null && oneDay.image!.length>0? Image.network(
                                              ConstantUrl.uploadUrl + oneDay.image!,
                                              fit: BoxFit.fill,
                                              width: Constants.getPercentSize(
                                                  cellSize, 70),
                                              height: Constants.getPercentSize(
                                                  cellSize, 70),
                                            ):Container( color: color, width: Constants.getPercentSize(
                                                cellSize, 70),
                                                height: Constants.getPercentSize(
                                                    cellSize, 70)),
                                          ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              ConstantWidget.getTextWidget(
                                                  "${(int.parse(oneDay.totalSecs!)/60).toStringAsFixed(1)} ${S.of(context).minutes} | ${oneDay.totalKcal!} ${S.of(context).kcal}",
                                                  subTextColor,
                                                  TextAlign.start,
                                                  FontWeight.w500,
                                                  ConstantWidget
                                    ...
                                    (index==0 && oneDay.is_completed==0) || (index>0 && oneDay.is_completed==0 && dayList[index-1].is_completed==1)?
                                    Container(
                                      child:  ConstantWidget.getIconButtonWidget(
                                          context, 'Start Training', borderColor: redColor, fillColor : redColor, fontColor : Colors.white, asset: "" ,() {
                                        ...
                                        //   builder: (context) {
                                        //     return WidgetMyPlanExerciseList(dummySend, color);
                                        //   },
                                        // ));
                                      }),
                                    ):SizedBox(),
