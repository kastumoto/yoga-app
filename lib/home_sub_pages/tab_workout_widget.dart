...
class _TabWorkout extends State<TabWorkout> {
  ...
  getBodySpecificWorkouts() async{
    var snapshot = await getAllBodySpecificCategory( context,);
              ...
              return GestureDetector(
                child: Stack(
                  ...
                  children: [
                    ...
                    getBodyWorkoutProWidget(isActive: _bodySpecificCategory.isActive??"0", context: context, quickWorkoutHeight: quickWorkoutHeight, color: color),
                  ...
                  checkIsProPlan(
                      ...
                      function: () {
                        ...
                        Navigator.of(context)
                          ...
                          builder: (context) {
                            return BodySpecificWorkoutList(
                                dummySend);
                          },
                        ));
                      });
  ...
  addOneOtherWorkOut(ModelOtherWorkoutCategory otherWorkoutCategory){
    List<ModelOtherWorkoutCategoryWorkout> workouts = otherWorkoutCategory.workouts??[];
    var oneItem =  Container(
      ...
      child: ListView.builder(
        ...
        scrollDirection: Axis.horizontal,
        itemBuilder: (context, index) {
          ModelOtherWorkoutCategoryWorkout oneOtherWorkout =
          workouts[index];
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 15,),
                          ConstantWidget.getCustomText(
                            "${(int.parse(oneOtherWorkout.totalMinutes!)*Constants.calDefaultCalculation).toStringAsFixed(1)} Kcal",
                            redColor,
                            1,
                            TextAlign.center,
                            FontWeight.w600,
              ...
              checkIsProPlan(
                  ...
                  function: () {
                    ...
                    new ModelDummySend(
                        ...
                        oneOtherWorkout.image!,
                        true,
                        oneOtherWorkout.description??"",//oneOtherWorkout.desc!,
                        QUICK_WORKOUT);
