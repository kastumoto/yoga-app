...
class _SignInPage extends State<SignInPage> {
                  ...
                  Expanded(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        ConstantWidget.getTextWidget(
                            "Welcome back to our account!",//"Version 1.0.0(24)",//
                            textColor,
                            TextAlign.left,
                            FontWeight.w400,
                        ...
                        ConstantWidget.getIconButtonWidget(
                            context, 'Sign in Now', borderColor: redColor, fillColor : redColor, fontColor : Colors.white, asset: "" ,() {
                          checkValidation((){});
                        }),
                        ConstantWidget.getIconButtonWidget(
                            context, 'Sign in with Facebook', borderColor: quickSvgColor, fillColor : quickSvgColor, fontColor : Colors.white, asset: "assets/images/facebook_logo.png" ,() {
                          //getKeyHash();
                          fb_login();
                        }),
                        ConstantWidget.getIconButtonWidget(
                            context, 'Sign in with Google', borderColor: blueButton, fillColor : blueButton, fontColor : Colors.white, asset: "assets/images/google_logo.png" ,() {
                          googlelogin();
                        }),
                        Platform.isIOS?
                          ConstantWidget.getIconButtonWidget(
                              context, 'Sign in with Apple', borderColor: accentColor, fillColor : accentColor, fontColor : Colors.white, asset: "assets/images/apple_logo.png" ,() {
                            ...
                            GestureDetector(
                              ...
                              onTap: () async {
                                ...
                                Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => SignUpDashboardPage((){ Navigator.pop(context);}),
                                    ));
                              },
                            )
                          ],
  ...
  checkNetwork(Function function) async {
    ...
    if (isNetwork) {
      signIn("0", userNameController.text, textPasswordController.text, function);
    } else {
  ...
  Future<void> _onPressedAppleSignInButton() async {
    ...
    print(credential);
    signIn("2", credential.identityToken??"", credential.identityToken??"", (){});
  }



  Future<void> signIn(String loginType, String userName, String password,  Function function) async {
