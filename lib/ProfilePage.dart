...
class _ProfilePage extends State<ProfilePage> {
  ...
  List<bool> areasBool = [];
  List<String> listFocusedAreas = ["Complete Body Contouring","Toned Arms","Trim Torso","Shapely Butt","Toned Legs"];
  int age = 0;
  int height = 0;
  int weight = 0;
  bool isEdit = false;
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            appBar: new AppBar(
              ...
              title: getCustomText("", Colors.white, 1,
                  TextAlign.start, FontWeight.w500, 20),
              leading: Padding(
                padding: EdgeInsets.all( ConstantWidget.getScreenPercentSize(context, 2.2)),
                child: getDefaultBackButton(context,function: (){ Navigator.of(context).pop();}),
              ),
            ),
            body: TabBarView(
              children: [
          ...
          child: ListView(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  if(isEdit){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => IntensivelyPage(intensivelyPosition, (value){
                      setState(() {
                ...
                child: ConstantWidget.getShadowWidget(radius: radius,widget: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ConstantWidget.getTextWidget(
                          ConstantUrl.getIntensivelyModel()[intensivelyPosition].title!,
                          Colors.black,
                          TextAlign.start,
                          FontWeight.w600,
                          ConstantWidget.getScreenPercentSize(context, 2)),
                      ...
                      ,
                      ConstantWidget.getTextWidget(
                          ConstantUrl.getIntensivelyModel()[intensivelyPosition].desc!,
                          Colors.black,
                          TextAlign.start,
                          FontWeight.w400,
                          fontSize)
              ...
              GestureDetector(
                onTap: (){
                  if(isEdit){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => SelectAreasPage(areasBool, (value){
                      setState(() {
                        areasBool = value;
                        updateSelectedAreas();
                      });
  ...
  void uploadBitmap() async {
    ...
    if (s.isNotEmpty) {
      ...
      request.fields[ConstantUrl.paramIntensively] =  intensivelyPosition.toString();
  ...
  void getUser() async {
    ...
    if (s.isNotEmpty) {
      ...
      setState(() {
        ...
        print(initCountry);
        _selectedDialogCountry= CountryPickerUtils.getCountryByName(initCountry);
        ...
        if(userDetail.intensively!=null && userDetail.intensively!.isNotEmpty){
