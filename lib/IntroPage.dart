      ...
      builder: (context, setState) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              getHeaderView(isDesired==true?  S.of(context).whatIsYourDesiredWeight :  S.of(context).whatIsYourWeight, isDesired == false ?
                          ...
                          child: Row(
                            ...
                            children: [
                              ConstantWidget.getTextWidget(
                                  isDesired==false? kg.toString() : desiredkg.toString(),
                                  Colors.black,
                                  TextAlign.end,
                                  FontWeight.w300,
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              //   child:
                              ConstantWidget.getTextWidget(
                                  isDesired==false? lbs.toInt().toString() : desiredlbs.toInt().toString(),
                                  Colors.black,
                                  TextAlign.start,
                                  FontWeight.w300,
                                  ConstantWidget.getPercentSize(subHeight, 25)),
              ...
              Center(
                child: Container(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(isDesired==false? "Your BMI:": "Your Taget BMI:", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
                      SizedBox(height: 5,),
                      Row(
                        children: [
                          Text( isDesired == false? yourBmi : yourDesiredBmi,  style: TextStyle(fontSize: 33, fontWeight: FontWeight.bold, color: redColor),),
                          SizedBox(width: 30,),
                          Text("Calculated on the\ninformation you have\ngiven.", style: TextStyle(fontSize: 12, color: Colors.grey),)
                        ],
                      )
                    ],
                  ),
    ...
    return StatefulBuilder(
      builder: (context, setState) => Container(
        ...
        child: Column(
          ...
          children: [
            space,
            getHeaderView("What is your fitness level?",
